...
#define NETINFO_MAC_DEFAULT				{0x00,0x08,0xdc,0x1d,0xed,0x76}
//#define NETINFO_IP_DEFAULT				{222,98,173,247}
//#define NETINFO_DNS_DEFAULT				{168,126,63,1}
//#define NETINFO_GATEWAY_DEFAULT			{222,98,173,254}
//#define NETINFO_SUBNETMASK_DEFAULT		{255,255,255,192}
#define NETINFO_IP_DEFAULT				{192,168,0,50}
#define NETINFO_DNS_DEFAULT				{8,8,8,8}
#define NETINFO_GATEWAY_DEFAULT			{192,168,0,1}
#define NETINFO_SUBNETMASK_DEFAULT		{255,255,255,0}
